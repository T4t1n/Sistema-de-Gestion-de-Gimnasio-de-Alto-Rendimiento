...
public class Competitivo extends Atleta {
    ...
    public Competitivo(){};
    public Competitivo(String nombre, String identificacion, int edad, int estatura, Categoria categoria, List<String> entrenamiento, double peso, int porcentajeDeGrasa) {
